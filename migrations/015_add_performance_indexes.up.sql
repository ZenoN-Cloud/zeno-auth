...
CREATE INDEX IF NOT EXISTS idx_refresh_tokens_fingerprint ON refresh_tokens(fingerprint);

-- Email verifications table
CREATE INDEX IF NOT EXISTS idx_email_verifications_user_id ON email_verifications(user_id);
CREATE INDEX IF NOT EXISTS idx_email_verifications_expires_at ON email_verifications(expires_at) WHERE verified_at IS NULL;
...
CREATE INDEX IF NOT EXISTS idx_password_reset_expires_at ON password_reset_tokens(expires_at) WHERE used_at IS NULL;
